            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }" >
                {{-- <li class="menu nav-item">
                    ...
                    <ul  x-cloak x-show="activeDropdown === 'dashboard'" x-collapse  class="sub-menu text-gray-500">
                        <li>
                            <a href="{{route('admin.dashboard')}}" class="@if(request()->route()->getName()=='admin.dashboard') active @endif">DashBoard</a>
                        </li>
                        <li>
                ...
                {{-- <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="{{ route('admin.user.management.index') }}" class="@if (in_array(request()->route()->getName(),['admin.user.management.index','admin.user.management.create'])) active @endif group">
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">User Mangemnet</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.to.do.list.index') }}" class="group @if (in_array(request()->route()->getName(),['admin.to.do.list.index'])) active @endif">
                                <div class="flex items-center">
                      ...
                      {{-- <li class="nav-item">
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'hotel-management'}"  @click="activeDropdown === 'hotel-management' ? activeDropdown = null : activeDropdown = 'hotel-management'">
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary"  width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Hotel Management </span>
                                </div>
                                <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'hotel-management'}">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19"  stroke="currentColor" stroke-width="1.5 stroke-linecap="round" />
                                    </svg>
                                </div>
                            </button>
                            <ul x-cloak x-show="activeDropdown === 'hotel-management'" x-collapse class="sub-menu text-gray-500">
                                <li>
                                    <a href="{{ route('admin.hotel.management.index') }}" class=" @if (in_array(request()->route()->getName(),['admin.hotel.management.index'])) active @endif" >Manage Hotel</a>
                                </li>
                               <li>
                                    <a href="{{route('admin.room.management.index')}}" class=" @if (in_array(request()->route()->getName(),['admin.room.management.index'])) active @endif">Manage Room</a>
                                </li>
                                 <li>
