 ...
 <header class="z-40" :class="{'dark' : $store.app.semidark && $store.app.menu === 'horizontal'}">
    <div class="shadow-sm">
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">toggleSidebar
                <a href="javascript;void" class="main-logo flex shrink-0 items-center">
                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ asset('assets/images/logo.svg') }}" alt="image" />
                    <span class="hidden align-middle text-2xl font-semibold transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">{{ env('APP_NAME') }}</span
                    >
                </a>
          ...
          {{--   <div class="hidden ltr:mr-2 rtl:ml-2 sm:block">
            ...
            >
                <div class="sm:ltr:mr-auto sm:rtl:ml-auto" x-data="{ search: false }" @click.outside="search = false">
                    ...
                    >
                        <div class="relative">
                            <input type="text"  class="peer form-input bg-gray-100 placeholder:tracking-widest ltr:pl-9 ltr:pr-9 rtl:pl-9 rtl:pr-9 sm:bg-transparent ltr:sm:pr-4 rtl:sm:pl-4"
                                placeholder="Search..."
                            />
                            <button
                                type="button"
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    >
                            ...
                            <div class="flex items-center px-4 py-4">
                                ...
                                <div class="truncate ltr:pl-4 rtl:pr-4">
                                    <h4 class="text-base">
                                        ...
                                        {{-- {{auth()->user()->name}} {{auth()->user()->last_name}}<span class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">{{auth()->user()->getRoleNames()->first()}}</span> --}}
                                    </h4>
                        ...
                        <li>
                            <a href="javascript:void()" class="dark:hover:text-white" @click="toggle">
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="javascript:void()" class="!py-3 text-danger" @click="toggle">
                                <svg
