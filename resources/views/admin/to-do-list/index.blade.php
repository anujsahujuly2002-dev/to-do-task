...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <div x-data="todolist">
        <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
            <div class="panel absolute z-10 hidden h-full w-[240px] max-w-full flex-none space-y-4 p-4 ltr:rounded-r-none rtl:rounded-l-none xl:relative xl:block xl:h-auto ltr:xl:rounded-r-md rtl:xl:rounded-l-md" :class="{'!block':isShowTaskMenu}" >
                <div class="flex h-full flex-col pb-16">
                    ...
                    <div class="perfect-scrollbar relative -mr-3.5 h-full grow pr-3.5">
                        <div class="space-y-1">
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary" :class="{ 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]': selectedTab === '' }"   @click="tabChanged('')" >
                                ...
                                <div class="whitespace-nowrap rounded-md bg-primary-light py-0.5 px-2 font-semibold dark:bg-[#060818]" x-text="allTasks && allTasks.filter((d) => d.status != 'trash').length" ></div>
                            </button>
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary" :class="{ 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]': selectedTab === 'complete' }"  @click="tabChanged('complete')">
                                <div class="flex items-center">
                                ...
                                <div class="whitespace-nowrap rounded-md bg-primary-light py-0.5 px-2 font-semibold dark:bg-[#060818]" x-text="allTasks && allTasks.filter((d) => d.status === 'complete').length">2</div>
                            </button>
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary" :class="{ 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]': selectedTab === 'important' }" @click="tabChanged('important')">
                                <div class="flex items-center">
                                    <svg width="24"  height="24" viewBox="0 0 24 24"  fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" >
                                ...
                                <div class="whitespace-nowrap rounded-md bg-primary-light py-0.5 px-2 font-semibold dark:bg-[#060818]"  x-text="allTasks && allTasks.filter((d) => d.status === 'important').length"></div>
                            </button>
                            <button type="button"  class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary" :class="{ 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]': selectedTab === 'trash' }" @click="tabChanged('trash')">
                                <div class="flex items-center">
                                    <svg  width="24"  height="24" viewBox="0 0 24 24" fill="none"  xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0">
                            ...
                            <button type="button" class="flex h-10 w-full items-center rounded-md p-1 font-medium text-success duration-300 hover:bg-white-dark/10 ltr:hover:pl-3 rtl:hover:pr-3 dark:hover:bg-[#181F32]":class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'team' }"  @click="tabChanged('team')" >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"  class="h-3 w-3 shrink-0 rotate-45 fill-success">
                            ...
                            <button type="button" class="flex h-10 w-full items-center rounded-md p-1 font-medium text-warning duration-300 hover:bg-white-dark/10 ltr:hover:pl-3 rtl:hover:pr-3 dark:hover:bg-[#181F32]":class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'low' }" @click="tabChanged('low')" >
                                <svg width="24"  height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 rotate-45 fill-warning">
                                    <path  d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor" stroke-width="1.5"/>
                                </svg>
                                <div class="ltr:ml-3 rtl:mr-3">Low</div>
                            </button>
                            <button  type="button"  class="flex h-10 w-full items-center rounded-md p-1 font-medium text-primary duration-300 hover:bg-white-dark/10 ltr:hover:pl-3 rtl:hover:pr-3 dark:hover:bg-[#181F32]" :class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'medium' }" @click="tabChanged('medium')" >
                                <svg width="24"  height="24"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 rotate-45 fill-primary" >
                                    <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor" stroke-width="1.5"/>
                                </svg>
                                <div class="ltr:ml-3 rtl:mr-3">Medium</div>
                            </button>
                            <button type="button" class="flex h-10 w-full items-center rounded-md p-1 font-medium text-danger duration-300 hover:bg-white-dark/10 ltr:hover:pl-3 rtl:hover:pr-3 dark:hover:bg-[#181F32]" :class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'high' }" @click="tabChanged('high')">
                                <svg width="24" height="24"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 rotate-45 fill-danger" >
                                    <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor" stroke-width="1.5"/>
                                </svg>
                                <div class="ltr:ml-3 rtl:mr-3">High</div>
                            </button>
                            <button type="button" class="flex h-10 w-full items-center rounded-md p-1 font-medium text-info duration-300 hover:bg-white-dark/10 ltr:hover:pl-3 rtl:hover:pr-3 dark:hover:bg-[#181F32]" :class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'update' }"  @click="tabChanged('update')">
                            ...
                            <table class="table-hover">
                                <tbody>
                                    <template x-for="task in pagedTasks">
                                        <tr :key="task.id" class="group cursor-pointer" :class="{ 'bg-white-light/30 dark:bg-[#1a2941]' : task.status_id === '3' }" >
                                            <td class="w-1">
                                                <input  type="checkbox" :id="`chk-${task.id}`" class="form-checkbox" :checked="task.status_id === '3'" @click.stop="taskComplete(task)" :disabled="selectedTab === 'trash'" />
                                            </td>
                                            <td>
                                                <div @click="viewTask(task)">
                                                    <div class="whitespace-nowrap text-base font-semibold group-hover:text-primary"  :class="{ 'line-through': task.status_id === '3' }" x-text="task.title" ></div>
                                                    <div class="min-w-[300px] overflow-hidden text-white-dark line-clamp-1"  :class="{ 'line-through':  task.status_id === '3' }"  x-text="task.description_text"></div>
                                                </div>
                                            </td>
                                            <td class="w-1">
                                                <div class="flex items-center space-x-2 ltr:justify-end rtl:justify-start rtl:space-x-reverse">
                                                    <template x-if="task.priority">
                                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                            <button type="button" class="badge rounded-full capitalize hover:top-0 hover:text-white" x-text="task.priority" :class="{ 'badge-outline-primary hover:bg-primary': task.priority === 'medium', 'badge-outline-warning hover:bg-warning': task.priority === 'low','badge-outline-danger hover:bg-danger': task.priority === 'high', 'text-white bg-primary': task.priority === 'medium' && open, 'text-white bg-warning': task.priority === 'low' && open, 'text-white bg-danger': task.priority === 'high' && open,}" @click="toggle"></button>
                                                            <ul x-cloak x-show="open" x-transition  x-transition.duration.300ms class="text-medium text-sm ltr:right-0 rtl:left-0">
                                                                <li> 
                                                                    <button class="w-full text-danger ltr:text-left rtl:text-right" @click="toggle,setPriority(task, 'high')"> High </button>
                                                                </li>
                                                                <li>
                                                                    <button class="w-full text-primary ltr:text-left rtl:text-right" @click="toggle,setPriority(task, 'medium')" > Medium</button>
                                                                </li>
                                                                <li>
                                                                    <button class="w-full text-warning ltr:text-left rtl:text-right" @click="toggle,setPriority(task, 'low')"> Low </button>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </template>
                                                    <template x-if="task.tag">
                                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                            <button type="button" class="badge rounded-full capitalize hover:top-0 hover:text-white" x-text="task.tag":class="{ 'badge-outline-success hover:bg-success': task.tag === 'team','badge-outline-info hover:bg-info': task.tag === 'update','text-white bg-success ': task.tag === 'team' && open, 'text-white bg-info ': task.tag === 'update' && open,}" @click="toggle" ></button>
                                                            <ul x-cloak x-show="open"  x-transition x-transition.duration.300ms class="text-sm font-medium ltr:right-0 rtl:left-0">
                                                                <li>
                                                                    <button class="w-full text-success" @click="toggle,setTag(task, 'team')">  Team </button>
                                                                </li>
                                                                <li>
                                                                    <button class="w-full text-info" @click="toggle,setTag(task, 'update')"> Update </button>
                                                                </li>
                                                                <li>
                                            ...
                                            <td class="w-1">
                                                <p class="whitespace-nowrap font-medium text-white-dark"  :class="{ 'line-through': task.status.name === 'complete' }" x-text="task.due_date"></p>
                                            </td>
                                            <td class="w-1">
                                                <div class="flex w-max items-center justify-between">
                                                    <div class="flex-shrink-0 ltr:mr-2.5 rtl:ml-2.5">
                                                        <template x-if="task.path"> <img :src="`../assets/images/${task.path}`" class="h-8 w-8 rounded-full object-cover" alt="avatar"  /> </template>
                                                        <template x-if="!task.path && task.assignee">
                                                            <div class="grid h-8 w-8 place-content-center rounded-full bg-primary text-sm font-semibold text-white" x-text="task.assignee.charAt(0) + '' + task.assignee.charAt(task.assignee.indexOf(' ') + 1)"></div>
                                                        </template>
                                                        <template x-if="!task.path && !task.assignee">
                        ...
                        <div class="p-5">
                            <form @submit.prevent="saveTask">
                                ...
                                <div class="mb-5">
                                    ...
                                    <select id="assignee" class="form-select" x-model="params.assginee_id">
                                ...
                                <div class="mb-5 flex justify-between gap-4">
                                    ...
                                    <div class="flex-1 ">
                                        ...
                                        <select id="priority" class="form-select" x-model="params.status_id">
                                ...
                                <div class="mb-5 flex justify-between gap-4">
                                    <div x-data="form">
                                        <div class="flex-1">
                                            ...
                                            <input id="due_date" type="text" placeholder="Due Date" class="form-input" x-model="params.due_date" />
                                        </div>
                                    </div>
                                    <div class="flex-1">
                                        <label for="category">Category</label>
                                        <select id="category" class="form-select" x-model="params.category_id">
                ...
                <div class="flex min-h-screen items-center justify-center px-4" @click.self="viewTaskModal = false">
                    <div x-show="viewTaskModal" x-transition x-transition.duration.300 class="panel my-8 w-[90%] max-w-lg overflow-hidden rounded-lg border-0 p-0 md:w-full">
                        ...
                        <div class="flex flex-wrap items-center gap-2 bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px] rtl:pr-5 rtl:pl-[50px] dark:bg-[#121c2c]">
                            ...
                            <div x-show="selectedTask.priority" x-text="selectedTask.priority" class="badge rounded-3xl capitalize" :class="{ 'badge-outline-primary': selectedTask.priority === 'medium','badge-outline-warning ': selectedTask.priority === 'low', 'badge-outline-danger ': selectedTask.priority === 'high',}" ></div>
                            <div x-show="selectedTask.tag"  x-text="selectedTask.tag" class="badge rounded-3xl capitalize" :class="{ 'badge-outline-success ': selectedTask.tag === 'team','badge-outline-info ': selectedTask.tag === 'update', }" ></div>
                        </div>
                        <div class="p-5">
...
<script>
    ...
    document.addEventListener('alpine:init', () => {    
        ...
        Alpine.data('todolist', () => ({
            ...
            async searchTasks(isResetPage = true) {
                try {
                    const response = await fetch(`{{ route('admin.to.do.list.get.to.do') }}`);
                    const result = await response.json();
                    this.allTasks = result.data; // Users on the current page
                } catch (error) {
              ...
              /*   if (type === 'delete') {
                ...
                .then(async (result) => {
                    if (result.value) {
                        try {
                            showloader()
                            const response = await fetch ("{{ route('admin.to.do.list.delete') }}",{
                                headers: {
            ...
            async saveTask () {
                ...
                if (this.params.id) {
                  ...
                  /*   this.pagedTasks = this.pagedTasks.map((d) => {
                    ...
                    this.pagedTasks = this.pagedTasks.map((d) => {
                        if (d.id === this.params.id) {
                            return {
                                ...
                                descriptionText: this.quillEditor.getText(),
                            };
                        }
                        return d;
                    });
                    let response =await this.editTask(this.pagedTasks[0]);
                    if(response.status){
                    ...
                    let response =await this.storeTask(task);
                    if(response.status){
                        this.showMessage(response.message)
                        this.addTaskModal = false; 
                        this.searchTasks(false);
            ...
            async storeTask(task) {
                try {
                    showloader()
                    const response = await fetch ("{{ route('admin.to.do.list.store') }}",{
                        headers: {
                            "X-CSRF-Token": "{{ csrf_token() }}",
                            "Content-Type": "application/json"
                        },
            ...
            async editTask(task) {
                try {
                    showloader()
                    const response = await fetch ("{{ route('admin.to.do.list.edit') }}",{
                        headers: {
                            "X-CSRF-Token": "{{ csrf_token() }}",
                            "Content-Type": "application/json"
                        },
            ...
            async getTask() {
                try {
                    const response = await fetch(`{{ route('admin.to.do.list.get.to.do') }}?page=${page}&per_page=${perPage}`);
                    const result = await response.json();
                    this.allTasks = result.data; // Users on the current page
                } catch (error) {
                    console.error('Error fetching data:', error);
            ...
            getRowsData() {
                return this.allTasks.map((task, index) => [
