            ...
            <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                    ...
                    <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                        <a href="{{route('admin.login')}}" class="block w-48 lg:w-72 ms-10">
                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    <div class="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                        <a href="{{ route('admin.login') }}" class="block w-8 lg:hidden">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form class="space-y-5 dark:text-white" id="loginForm">
                            <div class="username">
                                <label for="Email">Email</label>
                                <div class="relative text-white-dark">
                                    @csrf
                                    <input id="Email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" name="username"/>
                                ...
                                <p class="mt-1 text-danger username-error"></p>
                            </div>
                            <div class="password">
                                ...
                                <p class="mt-1 text-danger password-error"></p>
                            </div>
                            {{-- <div>
                    ...
                    <p class="absolute bottom-6 w-full text-center dark:text-white">
                        © <span id="footer-year">2022</span>. {{ env('APP_NAME') }} All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
...
@push('script')
    ...
    <script>
        const firebaseConfig = {
            apiKey: "AIzaSyBn8A7FzAKjI8M8Av1pZiCB1QkuquoAPqE",
            authDomain: "dookops.firebaseapp.com",
            projectId: "dookops",
            storageBucket: "dookops.appspot.com",
            messagingSenderId: "1092720169649",
            appId: "1:1092720169649:web:fdd3280b06495f3e464890",
            measurementId: "G-212WB14XFV"
        };
        // Initialize Firebase
        ...
        .then((permission) => {
            if (permission === 'granted') {
                return messaging.getToken({ vapidKey: 'BN86nBCXCtbAq4FrwuN9-rkepHgQjeESb_Mcx1oe2n5pvVxW67gyu12WhbjYFb1VfR2lSB_s02rI2cik8-rrsjU' });
            } else {
        ...
        .then((currentToken) => {
            if (currentToken) {
                $("input[name=fcm_token]").val(currentToken);
            } else {
        ...
        loginForm.onsubmit = async (e)=>{
            e.preventDefault();
            makeWithPostRequest("{{ route('admin.do.login') }}",loginForm)
        }
    </script>
@endpush
